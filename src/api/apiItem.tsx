...
const apiItem = (mainRouteName: string) => ({
  itemSave: (data: any) =>
    axios.post(`${URL_PREFIX}/item/${mainRouteName}`, data),
  itemUpdate: (data: any) =>
    axios.post(`${URL_PREFIX}/item/${mainRouteName}`, data),
  GetAllItems: () => axios.get(`${URL_PREFIX}/item/${mainRouteName}`),
  GetAllCompleteItems: () => axios.get(`${URL_PREFIX}/item/${mainRouteName}`),
  GetItemById: (id: any) =>
    axios.get(`${URL_PREFIX}/item/${mainRouteName}?id=${id}`),
  GetItemByCode: (id: any) =>
    axios.get(`${URL_PREFIX}/item/${mainRouteName}?id=${id}`),
  DeleteItemById: (id: any) =>
    axios.post(`${URL_PREFIX}/item/${mainRouteName}?id=${id}`),
});
